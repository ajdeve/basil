...
public class BurgerModelVirtualDB {
	...
	private BurgerModelVirtualDB() {
		list.add(new Feelings("Happy", new Burger("Bacon Cheese Burger", 10000, "Ozzing & Grilllllssss"),
				new Toppings("Steak Sauce", 500, "Normal"), new Sidemenu("Regular Fries", 7000, "Fries"),
				new Milkshake("Vanilla", 5000)));

		list.add(new Feelings("Angry", new Burger("Baconburger", 9000, "Callllllllllmdown"),
				new Toppings("Jalapeno peppers", 1000, "premium"), new Sidemenu("Chilly Dog", 10000, "Hot Dog"),
				new Milkshake("Chocolate", 6800)));

		list.add(new Feelings("Sad", new Burger("Hamburger", 8000, "What happened to you?"),
...
//	public void insertFeelings(newFeelings) {
//			list.add(newFeelings);	
